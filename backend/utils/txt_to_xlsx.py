...
MODEL_FILES_FOLDER = os.path.join(BASE_BOM_FOLDER, "a_1TE_FILES")
MAINBOARD_1_FILES_FOLDER = os.path.join(BASE_BOM_FOLDER, "b_MOTHERBOARD")
MAINBOARD_2_FILES_FOLDER = os.path.join(BASE_BOM_FOLDER, "c_MAIN_BOARD_FINAL")
